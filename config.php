...
define('PRODUCT_NAME_JP', 'CS-Cartスタンダード版');
define('PRODUCT_VERSION', '4.13.2_JP_1');
...
$config['updates_server'] = 'http://store.cs-cart.jp';

// external resources, related to product
$config['resources'] = array(
    'docs_url'                      => 'http://manual.cs-cart.jp/',
    'knowledge_base'                => 'http://manual.cs-cart.jp/',
    'faq'                           => 'https://www.cs-cart.com/faq.html',
    'updates_server'                => 'http://store.cs-cart.jp',
    'twitter'                       => 'cscartjp',
    'feedback_api'                  => 'https://cs-cart.jp/contact/',
    'product_url'                   => 'https://cs-cart.jp',
    'helpdesk_url'                  => 'https://cscart.liveagent.jp',
    ...
    'download'                      => 'https://cs-cart.jp/download/',
    'demo_product_buy_url'          => 'http://store.cs-cart.jp/cs-cart-standard.html',
    ...
    'admin_protection_url'          => 'http://manual.cs-cart.jp/4131jp1/ja/topic/admin-php',
    'widget_mode_url'               => 'https://docs.cs-cart.com/4.13.x/user_guide/look_and_feel/layouts/widget_mode/index.html',
    'developers_catalog'            => 'https://cs-cart.jp/developers/',
    'upgrade_center_specialist_url' => 'https://cs-cart.jp/update-service/',
    'upgrade_center_team_url'       => 'https://cscart.liveagent.jp/',
    ...
    'product_buy_url'               => 'http://store.cs-cart.jp/cs-cart-standard.html',
    ...
    'core_addons_supplier_url'      => 'https://cscart.liveagent.jp',
